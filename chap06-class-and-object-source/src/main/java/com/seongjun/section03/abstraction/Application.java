...
public class Application {
    ...
    public static void main(String[] args){
        ...
        /* 목표. 객체지향 프로그래밍에 대해 이해하고 객체와 클래스를 설계하여 프로그래밍 할 수 있다. */

        /* 객체를 설계하기 위해서는 복잡한 현실세계를 그래도 반영하기에는 너무 방대하고 복잡하기 때문에
         * 현실 시계를 프로그램의 목적에 맞게 단순화하는 추상화 라는 기법을 적용하게 된다.
         */
         ...
         *
         * 요구사항
         * 1. 카레이서는 시동걸리, 엑셀레이터 밝기, 브레이크 밝기, 시동 끄기를 할 수 있다.
         * 2. 자동차는 시동걸리, 앞으로가기, 멈추기, 시동 끄기를 할 수 있다.
         * 3. 자동차는 처음에 멈춘 상태로 대기하고 있는다.
         * 4. 카레이서는 먼저 자동차에 시동을 건다. 이미 걸려있는 경우 다시 시동을 걸 수 없다.
         * 5. 카레이서가 엑셀레이터를 밝으면 시동이 걸린 상태일 경우 자동차는 시속이 10km/h 증가하며 앞으로 나간다.
        ...
        while (true){
            ...
            switch (no) {
                case 1 : racer.starUp(); break;
                case 2 : racer.setpAccelator(); break;
